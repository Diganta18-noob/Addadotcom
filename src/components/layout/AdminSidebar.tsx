...
export function AdminTopbar({ sidebarCollapsed }: AdminTopbarProps) {
  ...
  return (
    <header
      className={cn(
        "fixed top-0 right-0 z-20 h-16 bg-background/95 backdrop-blur-md border-b border-border flex items-center justify-between px-6 transition-all duration-300",
